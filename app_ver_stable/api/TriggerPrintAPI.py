...
from app_ver_stable.starmarkupengine.schema_validators.BuzzerCountSchema import \
    BuzzerCountSchema
from app_ver_stable.starmarkupengine.schema_validators.DrawerSchema import DrawerSchema
from app_ver_stable.starmarkupengine.StarMarkupEngine import StarMarkupEngine
from app_ver_stable.starmarkupengine.tags import DrawerOpenModes
from app_ver_stable.starmarkupengine.value_validators.ValueValidators import must_not_be_blank
...
class TriggerPrint(Resource):
    ...
    def post(self):
        try:
            ...
            drawer_open_at = DrawerOpenModes.START.name
            ...
            markup = StarMarkupEngine.convertToStarMarkup(print_json, width)
