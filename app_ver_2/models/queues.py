# coding: utf-8
from app_ver_2.dbmanager.database import Base
from app_ver_2.dbmanager.database import db_session as db
from app_ver_2.dbmanager.database import dbtype, session_manager
from sqlalchemy import Column, Integer, String, Text, false, text
...
class Queue(Base):
    ...
    @classmethod
    def updatePosition(cls, queueId: int, markup: str, drawer_open_at: str = DrawerOpenModes.NONE.name , buzzers_at_start: int = 0, buzzers_at_end: int = 0):
