...
function UpdateDeviceTable() {
    $.get("devices" )
        .done(function(data) {
            ...
            table += "<thead><tr><th>Device</th><th style='width: 200px'>Connection Status</th><th style='width: 150px'>Queue</th><th>Client Type</th><th>Last Connection (UTC)</th><th></th></thead>";
